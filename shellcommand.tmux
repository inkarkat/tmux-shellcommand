...
[ "$shellcommand_key" ] && tmux bind-key ${shellcommand_table:+-T "$shellcommand_table"} "$shellcommand_key" \
...
[ "$shellcommand_repeat_key" ] && tmux bind-key ${shellcommand_repeat_table:+-T "$shellcommand_repeat_table"} "$shellcommand_repeat_key" paste-buffer -b shellcommand
...
[ "$shellcommand_recall_command_key" ] && tmux bind-key ${shellcommand_recall_command_table:+-T "$shellcommand_recall_command_table"} "$shellcommand_recall_command_key" \
...
[ "$shellcommand_recall_output_key" ] && tmux bind-key ${shellcommand_recall_output_table:+-T "$shellcommand_recall_output_table"} "$shellcommand_recall_output_key" \
